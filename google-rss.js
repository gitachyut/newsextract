...
let newKeywordStr = x.replace(/\s/g, "%20");
newKeywordStr = newKeywordStr.replace(/\"/g, "%22");

rssAddress = `https://news.google.com/rss/search?q=${newKeywordStr}+when:1h&hl=en-US&ceid=US:en&gl=US`
